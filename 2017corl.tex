...
$\cost\in\C^2(\State\times\Inp,\R)$ satisfies~\eqref{eq:c:nec_},~\eqref{eq:c:suf_}, and~\eqref{eq:c:stab} at $(\optstate,\optinp)\in\State\times\Inp$,
then 
...
Applying the $\PC^1$ Chain Rule~\citep[Thm.~3.1.1]{Scholtes2012-la} to~\eqref{eq:pc:nec} yields~\cf{~\cite[\S~3]{Robinson1991-xg}}
